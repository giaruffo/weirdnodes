...
if __name__ == "__main__":
    ...
    g01 = nper.perturbate_network_by_links(g0, NUM_LINKS_TO_PERTURBATE)
    g02 = nper.perturbate_network_by_nodes(g01, NUM_NODES_TO_PERTURBATE)
    g1 = nper.perturbate_network_with_intermediary_nodes(g02,  NUM_LINKS_TO_PERTURBATE, NUM_INTERMEDIARY_NODES)
