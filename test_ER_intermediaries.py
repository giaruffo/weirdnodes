...
2. Perturbates some nodes of the generated network, creating 'intermediaries', 'indirect_sources', and 'indirect_targets'.
...
if __name__ == "__main__":
    ...
    g1 = nper.perturbate_network_with_intermediary_nodes(g0, NUM_LINKS_TO_PERTURBATE, NUM_INTERMEDIARY_NODES)
